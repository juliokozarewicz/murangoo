...
class BasicTests(TestCase):
    ...
    def test_email_validation(self):
        s = "this.email.address.is.a.bit.too.long.but.should.still.validate@murangoo.com"  # noqa
    ...
    def test_build_absolute_uri(self):
        ...
        if not app_settings.SITES_ENABLED:
            ...
            request.META["SERVER_NAME"] = "murangoo.com"
        self.assertEqual(
            utils.build_absolute_uri(request, "/foo"), "http://murangoo.com/foo"
        )
        self.assertEqual(
            utils.build_absolute_uri(request, "/foo", protocol="ftp"),
            "ftp://murangoo.com/foo",
        )
        self.assertEqual(
